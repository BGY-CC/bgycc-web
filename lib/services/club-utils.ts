...
type ClubLike = Record<string, unknown>;
 ...
 */
export function getClubId(club: ClubLike | null | undefined): string | undefined {
 ...
 */
export function normalizeClubId(club: ClubLike | null | undefined): Club | null {
  if (!club) return null;
 ...
 */
export function filterAndNormalizeClubs(clubs: ClubLike[]): Club[] {
  return clubs
